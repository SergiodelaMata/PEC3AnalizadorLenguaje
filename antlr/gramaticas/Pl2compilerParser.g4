...
llamarfuncion: ((nombrefuncion operadoraperturaparentesis parametros? operadorcierreparentesis separadoroperaciones?) | funcionfor | funcionwhile | condicionales);
codigo: (funcionwhile|funcionfor|condicionales|asignacion|llamarfuncion|devolver|cuerpo2)+;
